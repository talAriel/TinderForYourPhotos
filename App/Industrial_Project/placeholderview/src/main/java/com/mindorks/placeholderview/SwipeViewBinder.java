...
//    TODO: Make mHasInterceptedEvent a AtomicBoolean, to make it thread safe.
    ...
    //Tinder For Your Photos start
    static private int anglesArray[] = {-15,10,-5,20,0,-20,5,-10,15};
    static private int currAngleIndex = 0;
    //Tinder For Your Photos end
    ...
    protected void bindView(V promptsView, int position, int swipeType, SwipeDecor decor,
        ...
        //Tinder For Your Photos start
        promptsView.setRotation(anglesArray[currAngleIndex]);
        currAngleIndex = (currAngleIndex + 1) % anglesArray.length;
        //Tinder For Your Photos end
